  ...
  <div class="in-wrap">
    ...
    <header id="header">
      <section class="container">
        ...
        <div class="h-r-nsl">
          <ul class="nav">
            <router-link to="/index" tag="li" active-class="current" exact>
              <a>首页</a>
            </router-link>
          ...
          <aside class="h-r-search">
            <label class="h-r-s-box">
              <input
                ...
                value
              />
              <router-link :to="{ path: '/course', query: { title: title } }">
      ...
      <section class="container">
        <div class="b-foot">
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                ...
                <span>Email：catmmao@gmail.com</span>
              </section>
          ...
          <aside class="fl col-3 tac mt15">
            <section class="gf-tx">
              <span>
                <a href="https://github.com/catmmao" target="_blank">
                  <svg
                    t="1618575299610"
                    class="icon"
...
export default {
  ...
  methods: {
    ...
    githubLogin() {
      ...
      login.getLoginUserInfo().then((result) => {
        //获取返回用户信息，放到cookie里面
    ...
    saveUserInfo() {
      ...
      login.updateUser(this.loginInfo).then(() => {
        this.$message({
          type: "success",
          message: "修改成功",
        });
